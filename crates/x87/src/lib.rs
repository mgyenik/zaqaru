...
//! | unmasked-exception delivery | not yet — flags and ES maintained now; delivery via the kernel's signal machinery |
//!
...
//!
//! The VM's lockstep oracle (`the engine/tests/lockstep.rs`) supplies the sequence:
