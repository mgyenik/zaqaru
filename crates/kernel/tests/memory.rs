...
use kernel::space::{Space, advice, map, prot};
...
fn fixture(label: &str) -> Fixture {
    let unique = std::time::SystemTime::now()
        ...
        .expect("clock")
        .as_nanos();
    let root = std::env::temp_dir().join(format!("the kernel-mem-{label}-{unique}"));
    ...
    let memory = Space_ {
        region: cpu::arena::Arena::new(ARENA as u64),
    };
...
fn a_file_mapping_refuses_what_cannot_be_mapped() {
    ...
    let fd = fixture.call(
        ...
        [
            directory,
            kernel::file::open_flags::DIRECTORY as i64,
            0,
            0,
            0,
            0,
...
fn mremap_grows_in_place_shrinks_and_moves() {
    ...
    let moved = fixture.call(
        ...
        [
            ...
            PAGE,
            2 * PAGE,
            kernel::space::remap::MAYMOVE as i64,
            0,
            0,
        ],
    );
    ...
    assert_eq!(
        fixture.call(
            ...
            [
                ...
                2 * PAGE,
                4 * PAGE,
                kernel::space::remap::FIXED as i64,
                0,
                0
            ]
        ),
