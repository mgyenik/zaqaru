...
impl FunctionBodyBuilder {
    ...
    simd_operations! {
        ...
        i8x16_min_signed = 118, i8x16_min_unsigned = 119,
        i8x16_max_signed = 120, i8x16_max_unsigned = 121,
        i16x8_shift_left = 139, i16x8_shift_right_signed = 140,
        i16x8_shift_right_unsigned = 141,
        i16x8_add = 142, i16x8_sub = 145, i16x8_mul = 149,
        i16x8_add_saturating_signed = 143, i16x8_add_saturating_unsigned = 144,
        i16x8_sub_saturating_signed = 146, i16x8_sub_saturating_unsigned = 147,
        i16x8_min_signed = 150, i16x8_min_unsigned = 151,
        i16x8_max_signed = 152, i16x8_max_unsigned = 153,
